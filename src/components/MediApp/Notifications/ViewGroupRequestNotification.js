...
class ViewGroupRequestNotification extends Component {
  ...
  render() {
    ...
    return (
      <TouchableOpacity style={[styles.postContainer, baseStyles.media, baseStyles.alignItemsCenter]}
                        onPress={() => Actions.groupMembersRequest({group: this.props.notification.group})}>
...
export default ViewGroupRequestNotification;
