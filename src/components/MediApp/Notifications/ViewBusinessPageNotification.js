...
class ViewBusinessPageNotification extends Component {
  ...
  render() {
    ...
    return (
      <TouchableOpacity style={[styles.postContainer, baseStyles.media, baseStyles.alignItemsCenter]}
                        onPress={() => Actions.businessProfileView({id: this.props.notification.object_id})}>
...
export default ViewBusinessPageNotification;
