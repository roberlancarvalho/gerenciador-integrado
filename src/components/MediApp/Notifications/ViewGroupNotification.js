...
class ViewGroupNotification extends Component {
  ...
  render() {
    ...
    return (
      <TouchableOpacity style={[styles.postContainer, baseStyles.media, baseStyles.alignItemsCenter]}
                        onPress={() => Actions.groupDetails({groupId: this.props.notification.object_id})}>
...
export default ViewGroupNotification;
